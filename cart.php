                        ...
                        if($check_coupons== "1"){
                           ...
                           $coupon_used = $row_coupons['coupon_used'];
                            ...
                            if($coupon_limit == $coupon_used){
                                ...
                                echo "<script>('Your Coupon Already Expired')</script>";
                                ...
                                if($check_cart == "1"){
                                      ...
                                      echo "<script>alert('cart.php','_self')</script>";
                     
                     

                                }else{
                                    echo "<script>alert('Your Coupon Didn't Match With You Product  On Your Cart')</script>";
