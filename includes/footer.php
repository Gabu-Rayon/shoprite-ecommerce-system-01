        ...
        <div class="row"><!-- row Begin -->
            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <p><!-- p Start -->
                    ...
                    <strong>M-GibsonsRayon Tech inc.</strong>
                    <br/>OnlineReach
                    <br/>Kenya
                    <br/>+254-75851-9193
                    <br/>iamtobago254@gmail.com
                    <br/><strong>M-GibsonsRayon </strong>
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; copyright <?php echo date('Y'); ?>
        M-GibsonsRayon Tech All Rights Reserve</p>
                
        </div><!-- col-md-6 Finish -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            
            <p class="pull-right">Theme by: <a href="#">M-GibsonsRayon </a></p>
