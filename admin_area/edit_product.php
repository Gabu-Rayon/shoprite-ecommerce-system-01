...
<body>
                    ...
                    <form method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <p style="font-weight:bold;font-style:italic;font-size:16px;"> Use Dash '-' for url. |
                                    Example: jacket-for-kids </p>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="manufacturer" class="form-control">
                                    ...
                                    <option selected value="<?php echo $manufacturer_id; ?>">
                                        <?php echo $manufacturer_title; ?> </option>
    ...
    <script>
    tinymce.init({
        selector: '#desc_editor, #features_editor'
    });
    </script>
</body>
